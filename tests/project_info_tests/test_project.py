...
def test_project(fake_project: Project):
    ...
    assert '__version__ = "1.3.0"' in fake_project.version.file.read_text(encoding='utf-8', errors='ignore')
    assert '__version__ = "1.2.3"' not in fake_project.version.file.read_text(encoding='utf-8', errors='ignore')
